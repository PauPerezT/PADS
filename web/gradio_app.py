...
For hosted demos, this file can be used as the app entry point in a
Hugging Face Space. The trained checkpoints should be available in
``checkpoints/one_sec`` or the path supplied in the interface.
"""
...
# the app is launched from the project directory.
import sys
...
def analyze_audio(
    ...
    if output_posteriors:
        posterior_table = result.to_dataframe()
    ...
    return summary, posterior_table, emotion_text, embeddings_file
